...
arch_group.add_argument('--model_name', type=str, default='METGen')
...
optim_group.add_argument('--epoch', default=70, type=int, metavar='N')
...
arg_parser.add_argument('--state',default='all',type=str)

arg_parser.add_argument('--T',default=1000,type=int)
